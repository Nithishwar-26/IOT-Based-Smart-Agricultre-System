...
String apiKey = "KAWYQZC63XFWTAZ6"; // Enter your Write API key from ThingSpeak
const char *ssid = "V2025";     // replace with your wifi ssid and wpa2 key
const char *pass = "deserves";
